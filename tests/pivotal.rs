...
use light_morse::{Morse, MorseType, MorseSubstitution};
...
mod tests {
    ...
    fn itu_and_gerke_differ() {
        let word1: Morse = "Morse".to_string();
        assert_ne!(word1.to_morse(MorseType::ITU), word1.to_morse(MorseType::Gerke))
    }
    ...
    fn gerke_differs() {
        let word1: Morse = "Morse".to_string();
        let word2: Morse = "Telegram".to_string();
        assert_ne!(word1.to_morse(MorseType::Gerke), word2.to_morse(MorseType::Gerke))
    }
}
